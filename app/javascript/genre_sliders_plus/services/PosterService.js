  ...
  startPosterStyle = () => {
    ...
    if (this.index < this.hoverItem) {
      if (this.hoverItem === this.slideLength - 1) {
        ...
        transform = this.translate3D(-(translateX * 2));
      } else {
        // transform = `translate3d(-${translateX}px, 0px, 0px)`;
        transform = this.translate3D(-translateX);
      }

      this.hoverStyle.transform = transform;
      ...
      if (this.index === 0) {
        ...
        // this.hoverStyle.transform = 'scale(1.75) translate3d(0px, 0px, 0px)';
